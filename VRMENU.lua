...
local rightHandMain = true-- Change this to false if ur born incorrect
local devMode = false
local mainHand
...
mainHand = rightHandMain and rightHand or leftHand 
...
middleMenuPart.Size = Vector3.new(3.5,5,0.2)
...
rightMenuPart.Size = Vector3.new(3.5,5,0.2)
...
leftMenuPart.Size = Vector3.new(3.5,5,0.2)
